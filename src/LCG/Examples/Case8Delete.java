...
public class Case8Delete {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * Here we delete the latest record in the database.
		 */ 
		int rec_tobe_deleted = recs.get().get(recs.get().size()-1).getID();
		Delete del_task = new Delete(table,rec_tobe_deleted);
